export default class MosaicSession {
    ...
    return new Promise((resolve, reject) => {
      ...
      self
        ...
        .then(function(data) {
          ...
          self
            .promiseGetSampleInfo(projectId, sampleId, isPedigree)
            .then((data) => {
              let promises = [];

              let pedigree = isPedigree
                ? data.pedigree
  ...
  parsePedigree(raw_pedigree, sample_id) {
    ...
    let probandIndex = raw_pedigree.findIndex(
      (d) =>
        d.id == sample_id && d.pedigree.maternal_id && d.pedigree.paternal_id
    );
